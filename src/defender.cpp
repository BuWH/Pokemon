...
//
#include "/Users/wenhe/code/Pokemon/include/defender.h"
...
void DefenderCreatrue::upgrade() {
    if (this->getLevel() < LEVEL_TOP) {
        ...
        this->setHp(static_cast<int>(this->getHp() + this->randomGrow(DEFENDER_GROW_HP)));
...
void DefenderCreatrue::initAbility() {
    ...
    this->setHp(static_cast<int>(DEFENDER_INIT_HP + round(n(e))));
