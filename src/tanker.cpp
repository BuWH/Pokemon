...
//
#include "/Users/wenhe/code/Pokemon/include/tanker.h"
...
void TankerCreatrue::upgrade() {
    if (this->getLevel() < LEVEL_TOP) {
        ...
        this->setHp(static_cast<int>(this->getHp() + this->randomGrow(TANKER_GROW_HP)));
...
void TankerCreatrue::initAbility() {
    ...
    this->setHp(static_cast<int>(TANKER_INIT_HP + round(n(e))));
